---
title: "npm 常用命令和使用技巧"
source: "https://www.arryblog.com/guide/js/npm-command.html"
category: "npm"
order: 4
---
...
用此方法才能准确的知道项目使用的版本号，查看 package.json 时，有“^" 符号表示大于此版本

## 4、npm 发布包

发包

允许我们将自己编写的包或命令行程序上传到 npm 服务器供别人使用

> 本次笔记，先不做详细流程，如果感兴趣可留言关注，后期分享 ^_^
