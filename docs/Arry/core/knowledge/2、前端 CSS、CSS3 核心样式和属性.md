---
title: "前端 CSS、CSS3 核心样式和属性"
source: "https://www.arryblog.com/knowledge/html5-css3/css-css3.html#_1%E3%80%81%E7%9B%92%E6%A8%A1%E5%9E%8B"
category: "CSS3"
order: 2
---
...
#定义变量
:root {
  --vp-font-mono: 'JetBrains Mono', 'Consolas', monospace;
}
#使用变量
.tag {
  font-family: var(--vp-font-mono);  /* 引用上面定义的变量 */
}
```
...
```markdown
:root 定义变量 → 任何元素都可以通过 var() 引用
     ↓
--vp-font-mono = 'JetBrains Mono', ...
     ↓
var(--vp-font-mono) → 解析为 → 'JetBrains Mono', ...
```

## 10、标签选择器、id、class选择器
