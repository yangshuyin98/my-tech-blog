---
title: "30 个 CSS/CSS3 真实项目案例布局（视频版）"
...
根据课程进度完成以下针对性案例开发，开发过程要求：
  ...
  + 利用 PS（Photoshop）与 PxCook 结合，在 PS 中的找到 PxCook-切图面板，选中想要切图的**图层** 或者 **图层组** ，然后点击切图面板上的 **标记为切图** 按钮 -> 再导出到 PxCook
...
![利用 CSS 绘制小三角形](https://www.arryblog.com/assets/img/1.16bfb371.jpg)

点击查看完整版视频讲解

## 2、利用 CSS 开发新闻列表

![利用 CSS 开发新闻列表](https://www.arryblog.com/assets/img/2.3e81432d.jpg)

点击查看完整版视频讲解

## 3、CSS 布局常见的产品展示效果

![常见的产品展示效果](https://www.arryblog.com/assets/img/3.21ca5f1d.jpg)

点击查看完整版视频讲解

## 4、常用的分页导航（不定项水平居中）

![常用的分页导航](https://www.arryblog.com/assets/img/4.61f5edf0.jpg)
...
![3D翻书效果](https://www.arryblog.com/assets/img/25.80593a9b.jpg)
